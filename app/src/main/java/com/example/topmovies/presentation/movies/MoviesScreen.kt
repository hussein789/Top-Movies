...
fun MoviesScreen(
    ...
    Box(modifier = modifier) {
        ...
        if (movieCallStatus == MovieCallState.LOADING) {
...
fun MoviesScreenPreview() {
    MoviesScreen(movies = listOf(Movie(1, "test", "", "30/5/2001", "Talk to me", 7.2, emptyList())), MovieCallState.LOADING, onMovieClicked = {})
}
